...
namespace OzzContextGen.WPF.ViewModels
{
    public class MainViewModel : AbstractViewModel
    {
        ...
        public MainViewModel()
        {
            ...
            PackCommand = new RelayCommand(async () => await PackContextAsync());
        }


        public ICommand BrowseSourceCommand { get; }
        public ICommand BrowseOutputCommand { get; }
        public ICommand BrowseProfileCommand { get; }
        public ICommand AnalyzeChangesCommand { get; }
        ...
        // GUI üzerinde checkbox'lar ile listelenecek diferansiyel dosya listesi
